...
export interface paths {
    ...
    "/meshes/{mesh}/workloads/{name}": {
        ...
        /** Returns Workload entity */
        get: operations["getWorkload"];
        /** Creates or Updates Workload entity */
        put: operations["putWorkload"];
        post?: never;
        /** Deletes Workload entity */
...
export interface components {
    schemas: {
        ...
        WorkloadItem: {
            ...
            /**
             * @description A unique identifier for this resource instance used by internal tooling and integrations. Typically derived from resource attributes and may be used for cross-references or indexing
             * @example kri_wl_default_zone-east_kuma-demo_myresource1_
             */
            readonly kri?: string;
            /** @description Name of the Kuma resource */
            name: string;
    ...
    responses: {
        ...
        /** @description Successful response */
        WorkloadCreateOrUpdateSuccessResponse: {
            headers: {
                [name: string]: unknown;
            };
            content: {
...
export interface operations {
    ...
    getWorkload: {
        ...
        requestBody?: never;
        responses: {
            200: components["responses"]["WorkloadItem"];
            404: components["responses"]["NotFound"];
        };
    };
    putWorkload: {
        ...
        responses: {
            200: components["responses"]["WorkloadCreateOrUpdateSuccessResponse"];
    ...
    deleteWorkload: {
        ...
        requestBody?: never;
        responses: {
            200: components["responses"]["WorkloadDeleteSuccessResponse"];
            404: components["responses"]["NotFound"];
        };
    };
    getWorkloadList: {
