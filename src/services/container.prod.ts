...
import ProgressBar from '@/app/common/ProgressBar.vue'
...
export const TOKENS = {
  ...
  ProgressBar: token<typeof ProgressBar>('ProgressBar'),
}
container.bind(TOKENS.ProgressBar)
  .toConstant(ProgressBar)
...
export const createContainer = () => {
  return new Container().extend(container)
}
